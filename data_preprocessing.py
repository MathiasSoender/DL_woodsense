...
#Show missing values for all attributes -> White lines indicate a missing value. From this plot it seems that some of the attrobutes are correlated
#according to missing values
#msno.matrix(df)
#plt.show()

#Shows a heatmap of the attributes where the missing values are correlated
#msno.heatmap(df)
#plt.show()

#Shows missing values as a bar plot
#msno.bar(df)
#plt.show()
